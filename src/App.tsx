...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 font-sans text-white overflow-x-hidden selection:bg-blue-600/30 selection:text-white">
      ...
      <AnimatePresence>
        {showSuccessBanner && (
          <motion.div
            ...
            className="fixed top-24 left-4 right-4 md:left-auto md:right-8 md:w-[380px] z-50 bg-zinc-900 border border-emerald-500/30 rounded-xl p-5 shadow-2xl flex items-start gap-4"
            style={{
          ...
          >
            ...
            <div className="flex-grow">
              <h4 className="text-sm font-semibold text-white">Transmission Received</h4>
      ...
      <footer className="w-full bg-zinc-950 border-t border-zinc-900/60 py-12 px-4 md:px-8 relative z-10 text-center">
